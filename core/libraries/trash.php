...
if( !function_exists( 'change2Latin' ) ){
  ...
  */
  function change2Latin( $sContent ){
    // Ręczne zamiany polskich znaków → ASCII
    $aPolishMap = array(
      'ą' => 'a', 'Ą' => 'A',
      'ć' => 'c', 'Ć' => 'C',
      'ę' => 'e', 'Ę' => 'E',
    ...
    // Najpierw zamieniamy polskie znaki "na twardo"
    $sContent = strtr( $sContent, $aPolishMap );

    // Potem dopiero iconv (dla innych znaków z poza PL)
