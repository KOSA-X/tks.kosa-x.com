...
$(document).ready(function() {
    ...
    function updateAll() {
        $.post('ajax.php', { action: 'get_all' }, function(data) {
            ...
            $('.obsWindow .time').attr('id', 'half_' + data.half);
            ...
            if (!isNaN(totalSeconds)) {
                ...
                if ((half == 1 && minutes >= 45) || (half == 2 && minutes >= 90)) {
                    $('.obsWindow .time').addClass('extra');
                } else {
                    $('.obsWindow .time').removeClass('extra');
                }
...
<div class="obsWindow">
    ...
    <div class="obsVisibility" id="wynik">
        <div class="obsMatch">
            <div class="team_name team_1"><?php echo $team_1_herb; ?><?php echo $team_1_short_name; ?></div>
            <div class="result"><span class="score-result">0:0</span></div>
            <div class="team_name team_2"><?php echo $team_2_short_name; ?><?php echo $team_2_herb; ?></div>
            <div class="time"><span id="timer">00:00</span></div>
        </div>
        <div class="obsVisibility__kosa">
            <img src="images/kosax-white.png" alt="KOSA X">
        </div>
    </div>
    ...
    <!-- PLANSZE INFO -->
    <div class="obsInfoBox">

        <!-- DZIEŃ MECZOWY -->
        <div class="infoBox dayMatch obsVisibility" id="dzien_meczowy">
            <header class="infoBox__header">
                <span class="info"><?php echo getData(7, "sPrice"); ?></span>
                <span class="title"><?php echo getData(7, "sName"); ?></span>
                <span class="date"><?php echo getData(7, "sDate"); ?></span>
            </header>
            <div class="infoBox__content">
                <div class="dayMatch__header">
                    <div class="team_1">
                        <?php echo $team_1_herb; ?>
                        <div class="name"><?php echo $team_1_name; ?></div>
                    </div>
                    <div class="result">
                    ...
                    <div class="team_2">
                        ...
                        <div class="name"><?php echo $team_2_name; ?></div>
                    </div>
                </div>
                <?php echo getData(7, "sDescriptionFull"); ?>
            </div>
            <?php echo infoBoxFooter(); ?>
        </div>
        ...
        <!-- AKTUALNY WYNIK -->
        <div class="infoBox matchScore matchScore_slim obsVisibility" id="aktualny_wynik">
            <header class="infoBox__header matchScore__header">
                <div class="matchScore__team_1"><?php echo $team_1_name; ?></div>
                <div class="matchScore__score"><span class="score-result">0:0</span></div>
                <div class="matchScore__team_2"><?php echo $team_2_name; ?></div>
            </header>
            <div class="infoBox__content">
                <div id="list_events_2"></div>
            </div>
        </div>

        <!-- SPONSOR MECZU -->
        <div class="infoBox matchScore obsVisibility" id="sponsor_meczu">
            <header class="infoBox__header matchScore__header">
                Sponsor meczu i transmisji na żywo
            </header>
            <div class="infoBox__content">
